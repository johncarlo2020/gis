    ...
    $(document).on("click" , '#user_view' , function () {
      ...
      $.ajax({
          ...
          success: function(data) {
            ...
            var role = '';
            if (data['0'].role == 1) {role = 'Admin'}
            if (data['0'].role == 2) {role = 'Registrar'}
            if (data['0'].role == 3) {role = 'Encoder'}
            ...
            <table>
              <tr>
                <th><p><b>Username : </b>`+data['0'].username+`</p></th>
              </tr>
              <tr>
                <th><p><b>Name : </b>`+data['0'].fname+` `+data['0'].mname+` `+data['0'].lname+`</p></th>
              </tr>
              <tr>
                <th><p><b>Address : </b>`+data['0'].address+`</p></th>
              </tr>
              <tr>
                <th><p><b>Mobile Number : </b>`+data['0'].mobile_no+`</p></th>
              </tr>
              <tr>
                <th><p><b>Email : </b>`+data['0'].email+`</p></th>
              </tr>
              <tr>
                <th><p><b>Role : </b>`+role+`</p></th>
              </tr>
            </table>`;
    ...
    $(document).on("click" , '#user_edit' , function () {
      ...
      $.ajax({
          ...
          success: function(data) {
            ...
            <div class="form-row">
                <div class="col">
                  <input type="text" name="fname" value="`+data['0'].fname+`" class="form-control addvalidator " placeholder="First name*" required>
                  <small id="required-fname" class="d-none" style="color:red">First name required</small>
                </div>
                <div class="col">
                  <input type="text" name="lname" value="`+data['0'].lname+`" class="form-control addvalidator " placeholder="Last name*" required>
                  <small id="required-lname" class="d-none" style="color:red">Last name required</small>
                </div>
                <div class="col">
                  <input type="text" name="mname" value="`+data['0'].mname+`" class="form-control " placeholder="Middle name" required>
                </div>
              </div>
              <div class="form-row mt-2">
                <div class="col-8">
                  <input type="text" name="address" value="`+data['0'].address+`" class="form-control addvalidator updatevalidator" placeholder="Address*" required>
                  <small id="required-address" class="d-none" style="color:red">Address required</small>
                  </div>
                <div class="col-4">
                  <input type="number" name="contact" value="`+data['0'].mobile_no+`"  class="form-control addvalidator" placeholder="Contact Number*" required>
                  <small id="required-contact" class="d-none row" style="color:red">contact required</small>
                </div>
              </div>
              <h4 class="mt-2">Account Information</h4>
              ...
              <div class="form-row mt-2">
                ...
                <div class="col">
                  <input type="email" name="email"  value="`+data['0'].email+`" class="form-control addvalidator" placeholder="Email address*" required>
                  <small id="error-email" class="d-none row" style="color:red">email Invalid </small>
                  <small id="required-email" class="d-none row" style="color:red">email required</small>
                </div>
                <div class="col">
...
$(document).on("click" , '#user_delete' , function () {
  ...
  var name = $(this).data('name');
      ...
      $('.modal-dialog').removeClass('modal-lg');
        ...
        var tmp_body = ` 
          <h4>Are you sure you want to delete <br><b>`+name+`</b> ?</h4>
          <hr>
       `;
...
$(document).on("click" , '#user_recover' , function () {
  var name = $(this).data('name');
      ...
      $('.modal-dialog').removeClass('modal-lg');
        ...
        var tmp_body = ` 
          <h4>Are you sure you want to recover <br><b>`+name+`</b> ?</h4>
          <hr>
       `;
